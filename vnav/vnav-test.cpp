// build: g++.exe -o vnt -g -Wall  -I . -lpthread  vnav-test.cpp src/*.cpp
//        assumes you have mingw installed somewhere and its in your path
#include <iostream>
...
static void asciiAsyncMessageReceived(void* userData, Packet& p, size_t index)
{
...
int main(int argc, char *argv[])
{
	...
	const char *p_port = (argc > 1 ? argv[1] : SensorPort.c_str());

	// Now let's create a VnSensor object and use it to connect to our sensor.
	VnSensor vs;
	vs.connect(p_port, SensorBaudrate);
